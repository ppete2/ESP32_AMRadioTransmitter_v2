...
I've tested the sketch with a standard ESP32 on a quite standard Dev-Module. It might work on other chips of the ESP32-family too. But because of the high timing limits, that's not for sure - you've to test it yourself on your specific module and with the help of an oscilloscope. 

A good tip for measuring HF-signals at ESP32' DAC-pin: You'll get clearer, quicker changing signals if you put a resistor of about 330 ohm between DAC-pin 25 and GND. Without the resistor especially the falling ramp of the signal is quite slow.

![Screenshot](https://github.com/ppete2/ESP32_AMRadioTransmitter_v2/signal.png)
...
The first task you've to do is converting an audio file (music etc.) of your choice to a header-file be using file "AudioToHeader.html". You've to test about the maximum length of your Audiofile, I attached one with 2 minutes.
Open your audio file, optionally select "normalize", and I advise to select "resample with" too with a number like 6000. Otherwise the headerfile would be too large and could not be loaded into ESP32's memory.
...
![Screenshot](https://github.com/ppete2/ESP32_AMRadioTransmitter_v2/buildup.png)

## History

* Idea and original code: "AM Radio Transmitter" by bitluni https://youtube.com/bitlunislab - sending him a warmly "High five"! : https://github.com/bitluni/ESP32AMRadioTransmitter  
* Project page: https://bitluni.net/am-radio-transmitter | Project video: https://youtu.be/lRXHd3HNzEo
